...
echo "bed_file;sampleID;treatment"                   > sample.txt
echo "HCT11_5Aza-10uM.cov.gz;HCT11_5Aza-10uM;HCT11" >> sample.txt
echo "HCT11_AMSA-10uM.cov.gz;HCT11_AMSA-10uM;HCT11" >> sample.txt
echo "HCT11_AMSA-30uM.cov.gz;HCT11_AMSA-30uM;HCT11" >> sample.txt
echo "HCT11_Extr-00uM.cov.gz;HCT11_Extr-00uM;HCT11" >> sample.txt
echo "HCT11_MPB7-10uM.cov.gz;HCT11_MPB7-10uM;HCT11" >> sample.txt
echo "HCT11_MPB7-30uM.cov.gz;HCT11_MPB7-30uM;HCT11" >> sample.txt
echo "HCT11_UM63-10uM.cov.gz;HCT11_UM63-10uM;HCT11" >> sample.txt
echo "HCT11_untr_00uM.cov.gz;HCT11_untr_00uM;HCT11" >> sample.txt
echo "HaCat_5Aza-10uM.cov.gz;HaCat_5Aza-10uM;HaCat" >> sample.txt
echo "HaCat_AMSA-10uM.cov.gz;HaCat_AMSA-10uM;HaCat" >> sample.txt
echo "HaCat_AMSA-30uM.cov.gz;HaCat_AMSA-30uM;HaCat" >> sample.txt
echo "HaCat_Extr-00uM.cov.gz;HaCat_Extr-00uM;HaCat" >> sample.txt
echo "HaCat_MPB7-10uM.cov.gz;HaCat_MPB7-10uM;HaCat" >> sample.txt
echo "HaCat_MPB7-30uM.cov.gz;HaCat_MPB7-30uM;HaCat" >> sample.txt
echo "HaCat_UM63-10uM.cov.gz;HaCat_UM63-10uM;HaCat" >> sample.txt
echo "HaCat_untr_00uM.cov.gz;HaCat_untr_00uM;HaCat" >> sample.txt
